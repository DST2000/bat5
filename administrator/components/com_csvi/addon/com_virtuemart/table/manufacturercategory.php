 ...
 * @since       6.0
 */
class VirtueMartTableManufacturerCategory extends CsviTableDefault
{
	/**
	 * Table constructor.
	 *
	...
	{
		parent::__construct('#__virtuemart_manufacturercategories', 'virtuemart_manufacturercategories_id', $db, $config);
	}
