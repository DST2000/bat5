 ...
 * @since       6.0
 */
class Com_VirtuemartModelExportGoogle extends CsviModelExports
{
	/**
	...
	private function getProductShippingPrice($product_id, $currency_code_3)
	{
		...
		{
			ob_start();
			require_once JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_virtuemart/helper/com_virtuemart_vmpsplugin.php';
			ob_clean();
		}
